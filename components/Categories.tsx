...
// Define o componente funcional `Categories`.
  ...
  const handleCategoryPress = (name: string) => {
    switch (name) {
      case 'Pizza':
        router.push('/(tabs)/screens/PizzaList');
        break;
      case 'Sushi':
        router.push('/(tabs)/screens/SushiList'); 
        break;
      case 'Hambúrguer':
        router.push('/(tabs)/screens/HamburguerList');
        break;
      case 'Chinesa':
        router.push('/(tabs)/screens/ChinesaList');
        break;
      default:
        console.warn('Categoria sem rota definida:', name);
    }
  };
